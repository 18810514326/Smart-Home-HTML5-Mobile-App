...
function(e, t) {
	...
	e.PopPicker = e.Class.extend({
		init: function(n) {
			var a = this;
			a.options = n || {}, a.options.buttons = a.options.buttons || ["Cancel", "Confirm"], a.panel = e.dom(i)[0], t.body.appendChild(a.panel), a.ok = a.panel.querySelector(".mui-poppicker-btn-ok"), a.cancel = a.panel.querySelector(".mui-poppicker-btn-cancel"), a.body = a.panel.querySelector(".mui-poppicker-body"), a.mask = e.createMask(), a.cancel.innerText = a.options.buttons[0], a.ok.innerText = a.options.buttons[1], a.cancel.addEventListener("tap", function(e) {
				a.hide()
...
function(e, t) {
	...
	e.DtPicker = e.Class.extend({
		...
		_create: function(e) {
			var t = this;
			e = e || {}, e.labels = e.labels || ["年", "月", "日", "Hour", "Minute"], e.buttons = e.buttons || ["Cancel", "Confirm"], e.type = e.type || "datetime", e.customData = e.customData || {}, t.options = e;
			var i = new Date,
				n = e.beginDate;
